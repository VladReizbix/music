...
API_TOKEN = '7965389648:AAG0QzsDY4GzDOh0F9dUB5Ra7Q9oA6dagzo'
MAX_FILE_SIZE = 50 * 1024 * 1024
MAX_RESULTS = 20
AD_ACTION_THRESHOLD = 20  # Показ рекламы каждые 20 действий
PREMIUM_DAYS = {"30": 30, "90": 90, "365": 365}
PREMIUM_PRICES = {"30": 199, "90": 499, "365": 2299}
NEW_USER_DISCOUNT = 0.20
ADMIN_IDS = [7026603143]
CHANNEL_ID = -1002715409948
CHANNEL_USERNAME = "@SoundPlus1"
PAYMENT_CHANNEL_ID = -1002747322675
...
def youtube_match_filter(info, *, incomplete):
    ...
    if duration and duration > 600:  # Исключить видео длиннее 10 минут
    ...
    try:
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            for e in entries:
                ...
                if not vid or not title:  # Пропускаем записи без ID или заголовка
            ...
            # Проверяем, если результатов нет и это не повторный запрос, пробуем fallback
